      ...
      <>
        ...
        <div className="tw-flex tw-flex-col tw-gap-1 tw-bg-gray-600 tw-bg-opacity-10 tw-rounded-md p-4 tw-mb-4">
          <div className="tw-flex tw-flex-col tw-gap-1">
            ...
            <span className="tw-text-xs tw-font-light tw-text-gray-400 tw-break-keep tw-mb-2">
              자동 캡쳐 또는 수동 캡쳐 모드에서 캡쳐한 결과와 처리 과정을 예시와 같이 인게임 오버레이(중앙 하단 최대 600px)로 표시합니다. 해당 오버레이 크기는
              피드백에 따라 추후 변경될 수 있습니다.
            </span>
          </div>
        </div>

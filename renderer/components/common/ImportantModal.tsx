...
export default function HomePanelComponent({
  noticeSection,
  updateSections,
  serviceSection,
}: HomePanelProps) {
  const dispatch = useDispatch()
  const { isHomePanelOpen, homePanelCategory, updateIndex, slideDirection } = useSelector(
                    ...
                    <button
                      className={`tw-px-4 tw-py-2 tw-text-sm ${
                        homePanelCategory === 'notice'
                          ? 'tw-border-b-2 tw-border-blue-500 tw-font-semibold'
                ...
                {homePanelCategory === 'notice' ? (
                  ...
                  <div className='tw-flex tw-flex-col tw-h-full'>
                    <div className='tw-flex tw-items-center tw-justify-between tw-mb-4'>
                      <h2 className='tw-text-lg tw-font-extrabold tw-px-1 tw-pt-1'>
                        {updateSections[updateIndex].title}
                      </h2>
                      <div className='tw-flex tw-gap-2'>
                        ...
                        <button
                          ...
                          className={`tw-p-2 tw-rounded hover:tw-bg-gray-700 ${
                            updateIndex === updateSections.length - 1

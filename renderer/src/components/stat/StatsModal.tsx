...
export default function StatsModal({ isOpen, onClose, stats }: StatsModalProps) {
  const data = {
    ...
    datasets: [
      {
        data: [stats.maxCombo, stats.perfect, stats.over999, stats.over995, stats.over99, stats.over97, stats.clear],
        backgroundColor: [
          ...
          <div className="tw-flex tw-min-h-full tw-items-center tw-justify-center tw-p-4">
            ...
            >
              <Dialog.Panel className="tw-w-full tw-max-w-3xl tw-transform tw-overflow-hidden tw-rounded-2xl tw-bg-gray-800 tw-p-6 tw-text-left tw-align-middle tw-shadow-xl tw-transition-all">
                <Dialog.Title as="div" className="tw-flex tw-justify-between tw-items-center tw-mb-4">
                  <h3 className="tw-text-lg tw-font-bold tw-text-white">플레이 통계</h3>
                  <button onClick={onClose} className="tw-text-gray-400 hover:tw-text-white tw-transition-colors">
                    <FaXmark size={20} />
                  </button>
                </Dialog.Title>

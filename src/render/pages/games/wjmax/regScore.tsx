...
//             projectRaUploadedPageData.gameCode == 'wjmax' &&
//             !isUploading ? (
//               <>
...
//                                   (projectRaUploadedPageData.songData.composer
//                                     ? ' / ' + projectRaUploadedPageData.songData.composer
//                                     : '') +
//                                   ' / ' +
...
//                               `${projectRaUploadedPageData.button}B`
//                             ][projectRaPattern].level.toFixed(1)}
//                           </span>
//                         </div>
...
//                               {projectRaUploadedPageData.maxCombo == 1 ? 'MAX COMBO' : ''}
//                             </span>
//                           </div>
//                         </div>
//                       </div>
...
export default function WjmaxRegScorePage() {
  return <></>
}
